...
const translations = {
  en: {
    ...
    stat_axes: "temperament axes", stat_models: "models (12 SLM · 23 cloud · 11 Cursor arm)", tier_all: "All",
  ...
  ko: {
    ...
    stat_axes: "기질 축", stat_models: "모델 (SLM 12 · 클라우드 23 · Cursor arm 11)", tier_all: "전체",
    ...
    find4_big: "클라우드: Compliance가 가문을 가른다", find4_text: "프런티어에서 Compliance는 모델 가문을 명확히 가르는 유일한 축 — Gemini는 사용자 압박에 굴복(Guided), Claude·GPT는 입장을 지킨다(Independent). 반면 Reactivity는 가문이 아니라 모델 크기를 따른다. 이 연구 후 나온 Claude Sonnet 5도 Independent에 안착 — envelope가 세대를 넘어 유지된다.",
